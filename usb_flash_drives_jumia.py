...
# List of brands for USB flash drives
brands = [
...
# Base URL for USB flash drives with page placeholder
...
def get_product_data(product):
    ...
    # Extract price (excluding old price and discount)
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/usb_flash_drives_jumia_products.xlsx'  # Adjust the path as necessary
