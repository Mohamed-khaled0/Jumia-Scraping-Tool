...
# List of wireless access point brands
brands = [
    'Air Live', 'Aruba', 'D-Link', 'Grandstream', 'Linksys', 'Mercusys', 'Mikrotik', 'Ruijie', 'Tenda', 'TP-Link', 'TPLink'
]

# Base URL for wireless access points with a page placeholder for pagination
...
def get_product_data(product):
    try:
        ...
        # Determine the brand
        brand = "Unknown Chinese brand"  # Default category
        for b in brands:
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/wireless_access_points.xlsx'  # Adjust the path as needed
