...
# List of scanner brands
brands = [
    'HP', 'TP-Link', 'Penpower', 'Ugreen', 'Canon', 'Epson','Oka'
]

# Base URL for scanners with page placeholder for pagination
    ...
    try:
        ...
        for brand in brands:
            if brand.lower() in name.lower():
                category = brand  # Match the brand
                break
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/scanners_jumia_products.xlsx'  # Adjust the path as necessary
