...
# Base URL for networking hubs with page placeholder
    ...
    try:
        ...
        for brand in brands:
            if brand.lower() in name.lower():
                ...
                break
        if not category:
            category = 'Unknown Chinese brand'  # Default category for unmatched brands
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/networking_hubs_jumia.xlsx'  # Adjust the path as necessary
