...
# List of brands for iOS phones (Apple only in this case)
brands = ['Apple']

# Base URL for iOS phones with page placeholder
...
def get_product_data(product):
    ...
    for brand in brands:
        if brand.lower() in name.lower():
            ...
            break
    if not category:
        category = 'Other'  # For all other brands (though in this case it's only Apple)
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/ios_phones_jumia_products.xlsx'  # Adjust the path as necessary
