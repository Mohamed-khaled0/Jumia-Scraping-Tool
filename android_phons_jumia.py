...
# List of brands for Android phones (Realme is now placed before Mi)
brands = [
    'Alcatel', 'Apple', 'Benco', 'Black Shark', 'CAT', 'Earldom', 'Generic', 'Honor', 'Iku', 'Infinix', 
    'Itel', 'Lava', 'Lenovo', 'M-Horse', 'Mi', 'Nokia', 'Nubia', 'OPPO', 'Poco', 'realme', 'Redmi', 
    'Samsung', 'TAG-PHONE', 'Tecno', 'unihertz', 'Vivo', 'VIVO MATTRESS', 'X-Plus', 'Xaomi', 'XIAOMI', 'ZTE'
]

# Base URL for Android phones with page placeholder
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/android_phones_jumia_products.xlsx'  # Adjust the path as necessary
