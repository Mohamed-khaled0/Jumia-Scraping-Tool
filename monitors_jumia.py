...
# List of brands for monitors
brands = [
    'Acer', 'Alienware', 'Aoc', 'Benq', 'Dahua', 'DELL', 'Elgato', 'Generic', 'HP',
    'Lenovo', 'Lumi', 'MSI', 'Philips', 'Samsung', 'XIAOMI'
]

# Base URL for monitors with page placeholder
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/monitors_jumia_products.xlsx'  # Adjust the path as necessary
