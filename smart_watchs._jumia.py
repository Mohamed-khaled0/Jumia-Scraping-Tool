...
# Base URL for smart watches with a page placeholder
...
def get_product_data(product):
    ...
    # Filter for products that contain "smartwatch" in the name
    ...
    if 'apple' in name.lower():
        ...
        category = 'Huawei'
    elif 'xiaomi' in name.lower():
        category = 'Xiaomi'
    elif 'garmin' in name.lower():
        category = 'Garmin'
    else:
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/smart_watches_jumia_products.xlsx'  # Adjust the path as necessary
