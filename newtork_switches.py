...
# List of brands for Computer Networking Switches
brands = [
...
# Base URL for the target page with a page placeholder
...
def get_product_data(product):
    try:
        ...
        category = 'Unknown Chinese brand'  # Default to unknown
        for brand in brands:
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/networking_switches_jumia.xlsx'  # Adjust the path
