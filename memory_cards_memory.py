...
# Base URL for mobile phone memory cards with page placeholder
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/memory_cards_jumia_products.xlsx'  # Adjust the path as necessary
