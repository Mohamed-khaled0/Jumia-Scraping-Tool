...
# List of brands for Android phones
brands = [
    'Alcatel', 'Apple', 'Benco', 'Black Shark', 'CAT', 'Earldom', 'Generic', 'Honor', 'Iku', 'Infinix',
    'Itel', 'Lava', 'Lenovo', 'M-Horse', 'Realme', 'Nokia', 'Nubia', 'OPPO', 'Poco', 'realme', 'Redmi',
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/android_phones_jumia_products.xlsx'  # Adjust the path
