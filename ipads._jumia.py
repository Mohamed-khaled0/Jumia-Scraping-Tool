...
# Only Apple iPads (example for filtering brand)
brands = ['apple']

# Base URL for iPads (Jumia) with page placeholder
base_url = 'https://www.jumia.com.eg/ipads/?page={}'  # Added page parameter for pagination
...
def get_product_data(product):
    ...
    # Extract product link (adjusted to get the correct href)
