...
# List of brands for External Hard Drives
brands = [
    'Ugreen', 'Redragon','Western', 'Sandisk','WD', 'Sytek', 'Universal', 'Samsung'
]

# Base URL for External Hard Drives with page placeholder
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/external_hd_jumia_products.xlsx'  # Adjust the path as necessary
