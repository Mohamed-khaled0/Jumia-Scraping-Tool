...
# List of brands for gaming laptops
brands = [
    'Acer', 'Alienware', 'Apple', 'Asus', 'Dell', 'Gigabyte', 'HP', 'Lenovo', 'MSI', 'Razer', 
    'Samsung', 'Toshiba', 'XPG', 'Xiaomi'
]

# Base URL for gaming laptops with page placeholder
...
def scrape_page(page_num):
    ...
    if response.status_code == 200:
        ...
        # Adjust the product div selection to use the correct tag and class for gaming laptops
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/gaming_laptops_jumia_products.xlsx'  # Adjust the path
