...
# List of brands for Audio and Video Accessories
brands = [
    ...
    "Meetion", "Microsoft", "Nacon", "Neutrik", "No Band", "Onikuma", "Ovleng", 
    "P47", "Philips", "Point", "Porodo", "Porsh Dob", "Powerology", "Rapoo", "Razer", 
    "Recci", "Redragon", "Rode", "Sades", "Saramonic", "Smile", "Soda", "SPEEDLINK", 
    "Speed Link", "Standard", "SUNWIND", "Techno Zone", "TERMINATOR", "UNIC", "XO", 
    "XTRIKE ME", "ZERO"
]

# Base URL for Audio and Video Accessories with page placeholder
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/audio_video_accessories_jumia.xlsx'  # Adjust the path as necessary
