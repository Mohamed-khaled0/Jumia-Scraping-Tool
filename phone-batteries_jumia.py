...
# List of brands for mobile phone batteries and battery packs
brands = [
...
# Base URL for batteries and battery packs with page placeholder
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/batteries_and_battery_packs_jumia_products.xlsx'  # Adjust the path as necessary
