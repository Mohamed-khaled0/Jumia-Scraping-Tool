...
# List of brands for Internal Hard Drives
brands = [
    'Crucial', 'Lexar', 'Samsung', 'Seagate', 'Team Group', 'Toshiba', 'WD', 'Western Digital'
]

# Base URL for Internal Hard Drives with page placeholder
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/internal_hd_jumia_products.xlsx'  # Adjust the path as necessary
