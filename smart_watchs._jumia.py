...
# List of popular smartwatch brands
brands = ['Apple', 'Samsung', 'Huawei', 'Xiaomi', 'Garmin']

# Base URL for smartwatches with a page placeholder
...
def get_product_data(product):
    ...
    for brand in brands:
        if brand.lower() in name.lower():
            ...
            break
    if not category:
        category = 'Unknown Chinese brand'  # For all other brands
...
def scrape_page(page_num):
    ...
    if response.status_code == 200:
        ...
        products = soup.find_all('article', {'class': 'prd _fb col c-prd'})  # Correct div class for products
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/smart_watches_jumia_products.xlsx'  # Adjust the path as needed
