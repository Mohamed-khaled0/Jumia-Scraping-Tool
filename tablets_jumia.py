...
# Base URL for tablets with page placeholder for pagination
...
def scrape_page(page_num):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Find all product entries on the page using the correct div and class
            products = soup.find_all('article', {'class': 'prd _fb col c-prd'})  # Corrected class to match the good script
            if not products:
