...
# List of brands for desktop computers
brands = [
    'Acer', 'Apple', 'ASUS', 'Dell', 'HP', 'Lenovo', 'MSI', 'Microsoft', 'Razer', 'Samsung', 
    'Toshiba', 'Xerox', 'Zotac'
]

# Base URL for desktop computers with page placeholder
...
def save_to_excel(data):
    ...
    file_path = 'C:/Users/dell/Desktop/desktop_computers_jumia_products.xlsx'  # Adjust the path as necessary
